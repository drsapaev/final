 ...
 * POST /auth/login c form-url-encoded:
  ...
  return (
    <div style={{ display: "grid", gap: 12, maxWidth: 360 }}>
      ...
      <form onSubmit={login} style={{ display: "grid", gap: 8 }}>
        ...
        <button type="submit" disabled={busy} style={btnPrimary}>Войти</button>
      </form>

      <small style={{ opacity: 0.7 }}>
        По умолчанию админ создаётся скриптом <code>ensure_admin.py</code> (admin/admin). Настраивается переменными окружения.
      </small>
    </div>
  );
}
