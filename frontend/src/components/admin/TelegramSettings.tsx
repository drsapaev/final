...
const TelegramSettings = () => {
  ...
  const testBot = async () => {
    try {
      ...
      setMessage({ type: 'danger', text: (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : String(error)) : String(error)) : String(error)) });
    }
  };
