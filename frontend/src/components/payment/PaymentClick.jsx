...
const PaymentClick = ({ 
          ...
          <div className="payment-init">
            ...
            <div className="payment-details">
              ...
              <div className="detail-row">
                ...
                <span className="detail-value">Click (онлайн)</span>
              </div>
            </div>
            
            <div className="payment-info">
              <p>После нажатия кнопки "Оплатить" откроется страница Click для завершения платежа.</p>
      ...
      case 'processing':
        return (
          <div className="payment-processing">
            ...
            <div className="payment-info">
              <p>Страница оплаты Click должна открыться в новом окне.</p>
            ...
            <div className="payment-instructions">
              ...
              <ul>
                ...
                <li>Или закройте окно Click и вернитесь сюда</li>
              </ul>
            </div>
          </div>
        );
        ...
        return (
          <div className="payment-polling">
            ...
            <div className="payment-info">
              ...
              <p>Вы можете закрыть окно Click и дождаться подтверждения здесь.</p>
            </div>
          </div>
        );
  ...
  return (
    ...
    <ModernDialog
      ...
      className="payment-click-dialog"
    >
      <div className="payment-click-container">
        {renderContent()}
      </div>
    </ModernDialog>
