...
export const ROUTE_REGISTRY = [
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Облачная печать', icon: 'printer', section: 'Интеграции', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Медицинское оборудование', icon: 'stethoscope', section: 'Интеграции', order: 40, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin', 'Doctor'],
    entry: 'direct',
    nav: nav({ label: 'Файлы', icon: 'doc.text', section: 'Интеграции', order: 50, sidebar: true }),
