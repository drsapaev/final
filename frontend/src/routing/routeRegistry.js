...
export const ROUTE_REGISTRY = [
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Вебхуки', icon: 'globe', section: 'Интеграции', order: 10, sidebar: true }),
    title: 'Админ: вебхуки',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Система', icon: 'gear', section: 'Операции', order: 10, sidebar: true }),
    title: 'Admin System',
    owner: 'admin.system',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Облачная печать', icon: 'printer', section: 'Операции', order: 20, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'Медицинское оборудование', icon: 'stethoscope', section: 'Операции', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ label: 'GraphQL API', icon: 'database', section: 'Интеграции', order: 20, sidebar: true }),
