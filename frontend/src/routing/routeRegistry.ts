...
export const SIDEBAR_PRESETS = {
  ...
  registrar: {
    ...
    items: [
      { id: 'registrar-home', labelKey: 'nav.overview', icon: 'chart.bar', to: '/registrar/welcome' },
      { id: 'registrar-queue', labelKey: 'nav.queue', icon: 'person.2', to: '/registrar/queue' },
      { id: 'clinical-appointments', labelKey: 'nav.appointments', icon: 'calendar', to: '/clinical/appointments' },
      { id: 'clinical-search', labelKey: 'nav.patients', icon: 'person.2', to: '/clinical/search' },
    ],
  },
  ...
  doctor: {
    ...
    items: [
      { id: 'dashboard', labelKey: 'nav.overview', icon: 'chart.bar' },
      { id: 'patients', labelKey: 'nav.patients', icon: 'person.2' },
      { id: 'appointments', labelKey: 'nav.appointments', icon: 'calendar' },
      { id: 'queue', labelKey: 'nav.queue', icon: 'person.2' },
      { id: 'ai', labelKey: 'nav.ai_assistant', icon: 'brain', ...AI_SIDEBAR_DISCLAIMER_META },
      { id: 'reports', labelKey: 'nav.reports', icon: 'doc.text' },
    ],
  },
  lab: {
    navigation: 'query',
    ...
    defaultItem: 'queue',
    items: [
      { id: 'queue', labelKey: 'nav.queue', icon: 'testtube.2' },
      { id: 'templates', labelKey: 'nav.templates', icon: 'rectangle.stack.badge.plus' },
      { id: 'reports', labelKey: 'nav.blanks', icon: 'doc.text' },
    ],
  },
  cardiology: {
    navigation: 'query',
  ...
  dentistry: {
    ...
    items: [
      { id: 'queue',         labelKey: 'nav.queue',      icon: 'list.number' },
      { id: 'visit',         labelKey: 'nav.visit',        icon: 'stethoscope' },
      { id: 'patients',      labelKey: 'nav.patients',     icon: 'person.2' },
...
export const ROUTE_REGISTRY = [
  ...
  },
  {
    ...
    homeForRoles: ['admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.overview', icon: 'chart.bar', section: 'Обзор', order: 10, menu: true, sidebar: true }),
    title: 'Админ: обзор',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.analytics', icon: 'chart.bar', section: 'Обзор', order: 20, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.reports_alt', icon: 'file-text', section: 'Обзор', order: 20, sidebar: true }),
    title: 'Admin Reports',
    owner: 'admin.reports',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.system', icon: 'gear', section: 'Система', order: 50, sidebar: true }),
    title: 'Admin System',
    owner: 'admin.system',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.users', icon: 'users', section: 'Система', order: 10, sidebar: true }),
    title: 'Admin Users',
    owner: 'admin.users',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.doctors', icon: 'user-plus', section: 'Пациенты и запись', order: 20, sidebar: true }),
    title: 'Admin Doctors',
    owner: 'admin.users',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.services', icon: 'list', section: 'Клиника и очередь', order: 50, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.queue_rooms', icon: 'building', section: 'Клиника и очередь', order: 20, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.patients', icon: 'users', section: 'Пациенты и запись', order: 10, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.appointments', icon: 'calendar', section: 'Пациенты и запись', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.allfree_requests', icon: 'exclamationmark.triangle', section: 'Пациенты и запись', order: 40, sidebar: true }),
  ...
  },
  {
    ...
    nav: nav({ labelKey: 'nav.discounts', icon: 'percent', section: 'Финансы', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.booking_wizard', icon: 'wand.and.stars', section: 'Пациенты и запись', order: 50, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.payment_systems', icon: 'creditcard', section: 'Финансы', order: 20, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.clinic_management', icon: 'building', section: 'Клиника и очередь', order: 10, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.clinic_profile', icon: 'building', section: 'Клиника и очередь', order: 55, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.queue_settings', icon: 'list.bullet', section: 'Клиника и очередь', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.ai_tools', icon: 'brain', section: 'Система', order: 20, sidebar: true, ...AI_SIDEBAR_DISCLAIMER_META }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.telegram_settings', icon: 'paperplane', section: 'Коммуникации', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    // P-003 fix: surfaced in sidebar (previously nav:false — orphan route).
    nav: nav({ labelKey: 'nav.queue_board', icon: 'tv', section: 'Клиника и очередь', order: 40, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.notifications', icon: 'bell', section: 'Коммуникации', order: 10, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.push_notifications', icon: 'bell', section: 'Коммуникации', order: 20, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.phone_verification', icon: 'phone', section: 'Коммуникации', order: 40, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.activation', icon: 'key', section: 'Система', order: 40, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'direct',
    nav: nav({ labelKey: 'nav.finance', icon: 'dollarsign.circle', section: 'Финансы', order: 10, sidebar: true }),
    title: 'Admin Finance',
    owner: 'admin.billing',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.settings', icon: 'gear', section: 'Система', order: 80, sidebar: true, menu: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.security', icon: 'lock', section: 'Система', order: 30, sidebar: true }),
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.audit', icon: 'list', section: 'Система', order: 30, sidebar: true }),
    title: 'Admin Audit',
    owner: 'admin.audit',
    component: 'Audit',
  ...
  },
  {
    ...
    roles: ['Admin'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.integrations', icon: 'puzzlepiece', section: 'Система', order: 55, sidebar: true }),
  ...
  },
  {
    ...
    entry: 'direct',
    nav: nav({ labelKey: 'nav.registrar', icon: 'users', section: 'Clinical', order: 10, menu: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    nav: nav({ labelKey: 'nav.doctor', icon: 'stethoscope', section: 'Clinical', order: 20, menu: true }),
    title: 'Doctor Panel',
  ...
  },
  {
    ...
    entry: 'menu',
    nav: nav({ labelKey: 'nav.cashier', icon: 'creditcard', section: 'Clinical', order: 30, menu: true }),
    title: 'Cashier Panel',
  ...
  },
  {
    ...
    homeForRoles: ['lab'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.lab', icon: 'testtube.2', section: 'Clinical', order: 40, menu: true }),
    title: 'Lab Panel',
    owner: 'clinical.lab',
    component: 'LabPanel',
  ...
  },
  {
    ...
    homeForRoles: ['cardio'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.cardiology', icon: 'heart', section: 'Clinical', order: 50, menu: true }),
  ...
  },
  {
    ...
    homeForRoles: ['derma'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.dermatology', icon: 'face.smiling', section: 'Clinical', order: 60, menu: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    nav: nav({ labelKey: 'nav.dentistry', icon: 'smile', section: 'Clinical', order: 70, menu: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    nav: nav({ labelKey: 'nav.schedule', icon: 'calendar', section: 'Clinical', order: 80, menu: true }),
  ...
  },
  {
    ...
    entry: 'menu',
    nav: nav({ labelKey: 'nav.appointments', icon: 'calendar', section: 'Clinical', order: 90, menu: true }),
  ...
  },
  {
    ...
    roles: ['Admin', 'Doctor', 'Registrar', 'Cashier', 'Lab', 'cardio', 'derma', 'dentist'],
    entry: 'menu',
    nav: nav({ labelKey: 'nav.search', icon: 'magnifyingglass', section: 'Clinical', order: 100, menu: true }),
