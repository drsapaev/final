/**
 * useDentalHotkeys — keyboard shortcuts for DentistPanelUnified.
 *
 ...
 * - Ctrl+4: switch to photos tab
 * - Ctrl+5: switch to ai-assistant tab
 * - F5: refresh data
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      if (e.key === 'F5') {
        ...
        if (refreshData) {
          refreshData();
          logger.info('[DentalHotkeys] Data refreshed');
        }
        return;
      }
