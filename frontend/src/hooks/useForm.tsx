...
export const useForm = (initialValues = {} as Record<string, unknown>, options = {} as Record<string, unknown>) => {
  const {
  ...
  // Валидация поля
  const validateField = useCallback((name, value, rules = {} as Record<string, unknown>) => {
    const fieldErrors = [];
