// Глобальная дизайн-система для всего приложения
...
export const componentSizes = {
  button: {
    ...
    md: { padding: '12px 24px', fontSize: '16px', height: '40px' },
    lg: { padding: '16px 32px', fontSize: '18px', height: '48px' }
  },
  input: {
    sm: { padding: '8px 12px', fontSize: '14px', height: '32px' },
    md: { padding: '12px 16px', fontSize: '16px', height: '40px' },
    lg: { padding: '16px 20px', fontSize: '18px', height: '48px' }
  }
};
