...
const COLOR_SCHEME_DEFINITIONS: Record<string, ColorSchemeDefinition> = {
  ...
  vibrant: {
    ...
    tokens: {
      ...
      '--mac-main-shell-bg': 'linear-gradient(180deg, rgba(85, 39, 47, 0.86) 0%, rgba(154, 71, 67, 0.78) 100%)',
  ...
  glass: {
    ...
    tokens: {
      ...
      '--mac-main-shell-bg': 'linear-gradient(180deg, rgba(12, 18, 27, 0.74) 0%, rgba(23, 37, 54, 0.66) 100%)',
  ...
  gradient: {
    ...
    tokens: {
      ...
      '--mac-nav-item-active-text': '#f7fbff',
      '--mac-main-shell-bg': 'linear-gradient(180deg, rgba(8, 42, 79, 0.74) 0%, rgba(22, 90, 161, 0.62) 100%)',
