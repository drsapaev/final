...
- [ ] **NURSE-V2 — Human Non-Doctor Clinical Serving** — a Nurse (human User role, never a QueueResource surrogate) serves an assigned queue at a cabinet/station: role + workplace assignment model, nurse-scoped queue serving API with real-user attribution, a mandatory two-nurse PostgreSQL concurrency proof, and a minimal tablet surface. (Owner decision 2026-09-18 — next product priority; track: `.ai-factory/plans/nurse-v2-clinical-serving.md`; plan approved via owner merge-checklist 2026-09-18 — N2-2 starts post-merge, runtime code holds until the N2-2 design gate.)
