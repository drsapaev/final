...
- Обновлено: 2026-09-11, RQ-20 DONE — оба обязательных ребенка завершены: RQ-20.a DONE (merged #3179, merge SHA `dcb8d5d94f4646eeb3d1be8927fb3da5368f69c8`) и RQ-20.b DONE (merged #3181, merge SHA `4c7d5f380612bc6322c0e4db9405a4380d294aea`; до этого RQ-19/RQ-06.c/RQ-06.b/RQ-06.a/RQ-06/RQ-03/RQ-02/RQ-01 DONE). Повторный клик по активной вкладке (toggle-off) сознательно НЕ менялся — план требует предварительного подтверждения требуемого поведения владельцем (характеризация в E-011); при подтверждении иного требуемого поведения — отдельный срез. Следующие минимальные незаблокированные: RQ-22 (сбой обновления списка; direct_execute для состояний загрузки, first-touch `useRegistrarWorklistData.ts`) либо RQ-06.d (нужен осознанный выбор владельца: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx` через отдельный gate). RQ-04/RQ-05 — валидация требует disposable PostgreSQL (P0): без него backend-часть BLOCKED.
...
- План: v1; исходный main аудита: `22febf376f710a3b3b6ce57ac85de589ebba3f21`; актуальный проверенный базис: `4c7d5f380612bc6322c0e4db9405a4380d294aea` (merged план #3157, RQ-01 #3159, RQ-02 #3160, docs-checkpoint #3162, RQ-03 #3163, docs #3164, payments #3166, RQ-06 #3167, docs #3168, RQ-06.a #3170, docs-reconcile #3171, RQ-06.b #3173, docs-reconcile #3174, RQ-06.c #3175, docs-reconcile #3176, RQ-19 #3177, docs-reconcile #3178, QD-2C #3114, RQ-20.a #3179, docs-reconcile #3180, RQ-20.b #3181).
...
- Следующий шаг: минимальные незаблокированные — RQ-22 (сбой обновления списка; direct_execute для состояний загрузки, first-touch `frontend/src/pages/registrar/useRegistrarWorklistData.ts`, `__tests__/useRegistrarWorklistData.test.ts`, минимальное отображение в `views/WorklistView.tsx`/`DataSourceIndicator.tsx`) либо RQ-06.d (выбор владельца дефекта: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx`; канонический Select — общий компонент, отдельный gate). Перед backend-задачами (RQ-05 и др.) требуется disposable PostgreSQL — иначе BLOCKED по P0. Задачи с пометкой «проверить #3114» (RQ-04/08/09/13/14/15/16/18/24) сверяют якоря с merged QD-2C (`4e3fe78c`) — head-сверка устарела.
