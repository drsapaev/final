...
- PR URL: PR этого среза (branch `codex/rq-06b-service-form-selects`); merge SHA — сверить в следующем цикле (статус PR_OPEN/VERIFIED до сверки).
- Status now: RQ-06.b VERIFIED (в границах этого PR).
- Blocker: нет (частные blockers E-003 не затрагивают этот срез).
