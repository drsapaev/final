...
- Обновлено: 2026-09-11, RQ-22 VERIFIED/PR_OPEN (сбой обновления списка; direct_execute для состояний загрузки — первый touch `useRegistrarWorklistData.ts` + `views/WorklistView.tsx` + `DataSourceIndicator.tsx`, evidence E-013). До этого RQ-20 DONE — оба обязательных ребенка завершены: RQ-20.a DONE (merged #3179, merge SHA `dcb8d5d94f4646eeb3d1be8927fb3da5368f69c8`) и RQ-20.b DONE (merged #3181, merge SHA `4c7d5f380612bc6322c0e4db9405a4380d294aea`; до этого RQ-19/RQ-06.c/RQ-06.b/RQ-06.a/RQ-06/RQ-03/RQ-02/RQ-01 DONE). Повторный клик по активной вкладке (toggle-off) сознательно НЕ менялся — план требует предварительного подтверждения требуемого поведения владельцем (характеризация в E-011). Следующее минимальное незаблокированное: RQ-06.d (нужен осознанный выбор владельца: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx` через отдельный gate) либо RQ-21.a (отличить «Нет совпадений» от пустой очереди; зависимости RQ-01+RQ-02 закрыты). RQ-04/RQ-05 — валидация требует disposable PostgreSQL (P0): без него backend-часть BLOCKED.
...
- План: v1; исходный main аудита: `22febf376f710a3b3b6ce57ac85de589ebba3f21`; актуальный проверенный базис: `4c7d5f380612bc6322c0e4db9405a4380d294aea` (merged план #3157, RQ-01 #3159, RQ-02 #3160, docs-checkpoint #3162, RQ-03 #3163, docs #3164, payments #3166, RQ-06 #3167, docs #3168, RQ-06.a #3170, docs-reconcile #3171, RQ-06.b #3173, docs-reconcile #3174, RQ-06.c #3175, docs-reconcile #3176, RQ-19 #3177, docs-reconcile #3178, QD-2C #3114, RQ-20.a #3179, docs-reconcile #3180, RQ-20.b #3181, docs-reconcile #3183).
- Реализация: 6/30 закрыто (RQ-01, RQ-02, RQ-03, RQ-06, RQ-19, RQ-20 DONE); дочерние срезы RQ-06.a DONE, RQ-06.b DONE, RQ-06.c DONE, RQ-20.a DONE, RQ-20.b DONE (детализация не повышает completion).
- Активная runtime-задача: RQ-22 (ветка `codex/rq-22-worklist-refresh-error`, PR этого среза). Владелец: codex-агент.
...
- Следующий шаг: после merge RQ-22 — docs-reconcile (RQ-22 DONE + базис) и далее RQ-06.d (выбор владельца дефекта: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx`; канонический Select — общий компонент, отдельный gate) либо RQ-21.a (ложное «пусто» при поиске без совпадений). Перед backend-задачами (RQ-05 и др.) требуется disposable PostgreSQL — иначе BLOCKED по P0. Задачи с пометкой «проверить #3114» (RQ-04/08/09/13/14/15/16/18/24) сверяют якоря с merged QD-2C (`4e3fe78c`) — head-сверка устарела.
...
| RQ-22 | Сбой обновления списка | RQ-01 | PR_OPEN | codex/rq-22-worklist-refresh-error / [#3184](https://github.com/drsapaev/final/pull/3184) / E-013 | E-013 |
