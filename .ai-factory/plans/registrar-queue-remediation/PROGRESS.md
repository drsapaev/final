...
- Обновлено: 2026-09-11, RQ-19 PR_OPEN (срез ARIA tabs, ветка codex/rq-19-tabs-a11y от базиса bf4d2502, evidence E-010); до этого RQ-06.c DONE (merged #3175, merge SHA `4732e7e773d82710eec384c48e6a91f79b50a9fe`); RQ-06.b/RQ-06.a/RQ-06/RQ-03/RQ-02/RQ-01 DONE. Следующая минимальная незаблокированная задача после merge RQ-19 — RQ-20 (зависимость RQ-19) либо RQ-06.d (числовые value в Select — нужен осознанный выбор владельца: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx` через отдельный gate). RQ-04/RQ-05 — валидация требует disposable PostgreSQL (P0): без него backend-часть BLOCKED.
- План: v1; исходный main аудита: `22febf376f710a3b3b6ce57ac85de589ebba3f21`; актуальный проверенный базис: `bf4d2502312fe72856c6c6938d22adbeafc3107c` (merged план #3157, RQ-01 #3159, RQ-02 #3160, docs-checkpoint #3162, RQ-03 #3163, docs #3164, payments #3166, RQ-06 #3167, docs #3168, RQ-06.a #3170, docs-reconcile #3171, RQ-06.b #3173, docs-reconcile #3174, RQ-06.c #3175, docs-reconcile #3176).
- Реализация: 4/30 закрыто (RQ-01, RQ-02, RQ-03, RQ-06 DONE); дочерние срезы RQ-06.a DONE, RQ-06.b DONE, RQ-06.c DONE (детализация не повышает completion).
- Активная runtime-задача: RQ-19 PR_OPEN (codex/rq-19-tabs-a11y). Владелец: облачный агент этого среза.
...
| RQ-19 | Читаемые вкладки/ARIA | RQ-01 | PR_OPEN | codex/rq-19-tabs-a11y / см. E-010 | E-010 |
...
- PR URL: [#3177](https://github.com/drsapaev/final/pull/3177).
