...
- Обновлено: 2026-09-11, RQ-19 DONE (merged #3177, merge SHA `ab24bdba9de7600bab1e1a120af0a546f5b3039f`); до этого RQ-06.c DONE (merged #3175, merge SHA `4732e7e773d82710eec384c48e6a91f79b50a9fe`); RQ-06.b/RQ-06.a/RQ-06/RQ-03/RQ-02/RQ-01 DONE. Следующая минимальная незаблокированная задача — RQ-20 (зависимость RQ-19 теперь закрыта; D-07 только при смене маршрутов) либо RQ-06.d (числовые value в Select — нужен осознанный выбор владельца: строковые value опций в ServiceCatalog против канонического `ui/macos/Select.tsx` через отдельный gate). RQ-04/RQ-05 — валидация требует disposable PostgreSQL (P0): без него backend-часть BLOCKED.
