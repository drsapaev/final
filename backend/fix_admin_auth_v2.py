...
MESSAGE = """
fix_admin_auth_v2.py is retired.

This legacy helper directly inspected and modified admin credentials in a local
SQLite database. Admin bootstrap and controlled credential reset belong to the
