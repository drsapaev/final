...
def test_print_ticket_pdf_edge_cases(token):
    ...
    edge_cases = [
        {"department": "A", "ticket_number": "1", "description": "Минимальная длина department"},
        {"department": "A" * 64, "ticket_number": "1", "description": "Максимальная длина department"},
        {"department": "", "ticket_number": "1", "description": "Пустой department"},
        {"department": "THERAPY", "ticket_number": "0", "description": "Номер билета = 0"},
        {"department": "THERAPY", "ticket_number": "-1", "description": "Отрицательный номер билета"},
        {"department": "THERAPY", "ticket_number": "abc", "description": "Нечисловой номер билета"},
    ]
...
def test_print_security_edge_cases():
    ...
    for case in security_cases:
        try:
            ...
            print_url = f"{BASE_URL}/api/v1/print/ticket.pdf?department=THERAPY&ticket_number=1"
...
def main():
    ...
    tests = [
        ("Граничные случаи PDF билетов", lambda: test_print_ticket_pdf_edge_cases(token)),
        ("Граничные случаи PDF счетов", lambda: test_print_invoice_pdf_edge_cases(token)),
        ("Граничные случаи безопасности", test_print_security_edge_cases),
        ("Граничные случаи производительности", lambda: test_print_performance_edge_cases(token))
    ]
