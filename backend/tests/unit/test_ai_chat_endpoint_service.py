...
@pytest.mark.unit
class TestAIChatEndpointService:
    def test_get_session_payload_raises_when_session_missing(self):
        ...
        service = AIChatEndpointService(db=None, repository=repository)

        with pytest.raises(AIChatDomainError) as exc_info:
