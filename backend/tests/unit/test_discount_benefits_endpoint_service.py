...
@pytest.mark.unit
class TestDiscountBenefitsEndpointService:
    def test_get_discounts_uses_existing_domain_service_for_active_only(self):
        ...
        service = DiscountBenefitsEndpointService(
            db=None,
    ...
    def test_update_discount_raises_when_missing(self):
        ...
        service = DiscountBenefitsEndpointService(db=None, repository=Repository(), discount_service=None)

        with pytest.raises(DiscountBenefitsDomainError) as exc_info:
