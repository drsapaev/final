...
@pytest.mark.unit
class TestRegistrarNotificationsEndpointService:
    def test_get_appointment_context_raises_when_appointment_missing(self):
        ...
        service = RegistrarNotificationsEndpointService(db=None, repository=Repository())

        with pytest.raises(RegistrarNotificationsDomainError) as exc_info:
    ...
    def test_get_queue_entry_raises_when_missing(self):
        ...
        with pytest.raises(RegistrarNotificationsDomainError):
