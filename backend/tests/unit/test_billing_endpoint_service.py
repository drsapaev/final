...
@pytest.mark.unit
class TestBillingEndpointService:
    def test_delete_invoice_rejects_non_draft(self):
        ...
        service = BillingEndpointService(db=None, repository=Repository())

        with pytest.raises(BillingDomainError) as exc_info:
    ...
    def test_serialize_payments_returns_expected_payload(self):
        ...
        payload = BillingEndpointService.serialize_payments([payment])
