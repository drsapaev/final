...
from app.services.analytics_simple_endpoint_service import AnalyticsSimpleService


@pytest.mark.unit
class TestAnalyticsSimpleService:
    def test_get_quick_stats_returns_expected_payload(self):
        ...
        service = AnalyticsSimpleService(db=None, repository=repository)
