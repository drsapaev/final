...
@pytest.mark.unit
class TestAuthenticationEndpointService:
    def test_update_user_profile_updates_fields_and_returns_profile(self):
        ...
        service = AuthenticationEndpointService(db=None, repository=repository)
    ...
    def test_ensure_session_access_raises_when_missing(self):
        ...
        with pytest.raises(AuthenticationDomainError) as exc_info:
