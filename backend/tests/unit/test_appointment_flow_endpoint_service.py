...
@pytest.mark.unit
class TestAppointmentFlowEndpointService:
    def test_resolve_appointment_from_visit_sets_emr_appointment_id(self):
        ...
        service = AppointmentFlowEndpointService(db=None, repository=Repository())
    ...
    def test_resolve_appointment_from_visit_raises_when_visit_missing(self):
        ...
        with pytest.raises(AppointmentFlowDomainError):
    ...
    def test_resolve_canonical_visit_delegates_to_shared_service(self):
        ...
        service = AppointmentFlowEndpointService(
            db=None,
