...
def check_database_roles():
    ...
    try:
        ...
        critical_users = ['admin', 'registrar', 'lab', 'doctor', 'cashier', 'cardio', 'derma', 'dentist']
        
        for username in critical_users:
            cursor.execute('SELECT role, is_active FROM users WHERE username = ?', (username,))
...
def check_role_consistency():
    ...
    expected_roles = ['Admin', 'Registrar', 'Lab', 'Doctor', 'Cashier', 'cardio', 'derma', 'dentist']
