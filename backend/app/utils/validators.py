...
def validate_amount(
    ...
    min_amount: int | float | Decimal = 0,
    max_amount: int | float | Decimal | None = None
) -> tuple[bool, str | None]:
    """
...
def format_currency_uzs(amount: int | float | Decimal) -> str:
    """
...
def validate_id(value: Any, field_name: str = "ID") -> tuple[bool, str | None]:
    """
