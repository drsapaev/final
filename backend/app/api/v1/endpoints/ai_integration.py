    ...
    try:
        ...
        async with await get_ai_service(db) as ai_service:
            ...
            complaints_result = await ai_service.analyze_complaints(
                ...
                specialty=current_user.role if current_user.role in ["cardio", "derma", "dentist"] else "general"
            )
