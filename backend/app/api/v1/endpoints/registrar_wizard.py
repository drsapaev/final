...
def create_cart_appointments(
    ...
    try:
        ...
        # РЎРѕР·РґР°С‘Рј Р·Р°РїРёСЃРё РІ РѕС‡РµСЂРµРґРё РґР»СЏ РїРѕРґС‚РІРµСЂР¶РґРµРЅРЅС‹С… РІРёР·РёС‚РѕРІ РЅР° СЃРµРіРѕРґРЅСЏ
        # Р’ РЅРѕРІРѕРј СЂРµР¶РёРјРµ РІРёР·РёС‚С‹ СЃРѕР·РґР°СЋС‚СЃСЏ СЃСЂР°Р·Сѓ РїРѕРґС‚РІРµСЂР¶РґРµРЅРЅС‹РјРё (СЂРµРіРёСЃС‚СЂР°С‚РѕСЂ)
        queue_numbers = {}
        today = date.today()
        ...
        for visit in created_visits:
            if visit.visit_date == today and visit.status == "confirmed":
                try:
                    # РСЃРїРѕР»СЊР·СѓРµРј С„СѓРЅРєС†РёСЋ РёР· СѓС‚СЂРµРЅРЅРµР№ СЃР±РѕСЂРєРё РґР»СЏ РїСЂРёСЃРІРѕРµРЅРёСЏ РЅРѕРјРµСЂРѕРІ
                    # [OK] РРЎРџР РђР’Р›Р•РќРћ: РЈР±РµР¶РґР°РµРјСЃСЏ, С‡С‚Рѕ VisitService РёРјРїРѕСЂС‚РёСЂРѕРІР°РЅ РґР»СЏ РёСЃРїРѕР»СЊР·РѕРІР°РЅРёСЏ РІ morning_assignment
                    from app.models.visit import VisitService
                    from app.services.morning_assignment import MorningAssignmentService

                    service = MorningAssignmentService()
                    service.db = db  # РСЃРїРѕР»СЊР·СѓРµРј СЃСѓС‰РµСЃС‚РІСѓСЋС‰СѓСЋ СЃРµСЃСЃРёСЋ
                    # Р”Р»СЏ СЂСѓС‡РЅРѕР№ СЂРµРіРёСЃС‚СЂР°С†РёРё С‡РµСЂРµР· РјР°СЃС‚РµСЂР° РёСЃС‚РѕС‡РЅРёРє РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ 'desk'
                    ...
                    if queue_assignments:
                        visit.status = "open"  # Р“РѕС‚РѕРІ Рє РїСЂРёРµРјСѓ
                        queue_numbers[visit.id] = queue_assignments
                        logger.info(
                            "REGISTRATION: Р’РёР·РёС‚ %d - РїСЂРёСЃРІРѕРµРЅРѕ %d РЅРѕРјРµСЂРѕРІ РІ РѕС‡РµСЂРµРґСЏС… (source=desk)",
                            visit.id,
                            len(queue_assignments),
                        )
                    else:
                        logger.warning(
                            "REGISTRATION: Р’РёР·РёС‚ %d - РЅРµ СѓРґР°Р»РѕСЃСЊ РїСЂРёСЃРІРѕРёС‚СЊ РЅРѕРјРµСЂР° РІ РѕС‡РµСЂРµРґСЏС… (source=desk)",
                            visit.id,
                        )
                except Exception as e:
                    logger.warning(
                        "REGISTRATION: РћС€РёР±РєР° РїСЂРёСЃРІРѕРµРЅРёСЏ РѕС‡РµСЂРµРґРµР№ РґР»СЏ РІРёР·РёС‚Р° %d (source=desk): %s",
                        visit.id,
                        str(e),
                        exc_info=True,
                    )
                    # РќРµ РїСЂРµСЂС‹РІР°РµРј СЃРѕР·РґР°РЅРёРµ РІРёР·РёС‚Р° РёР·-Р·Р° РѕС€РёР±РєРё РѕС‡РµСЂРµРґРµР№
                    continue
...
def _assign_queue_numbers_on_confirmation(
    ...
    """
    РџСЂРёСЃРІР°РёРІР°РµС‚ РЅРѕРјРµСЂР° РІ РѕС‡РµСЂРµРґСЏС… РїСЂРё РїРѕРґС‚РІРµСЂР¶РґРµРЅРёРё РІРёР·РёС‚Р° РЅР° СЃРµРіРѕРґРЅСЏ
    Р’РѕР·РІСЂР°С‰Р°РµС‚ (queue_numbers, print_tickets)
    """
    from app.models.online_queue import DailyQueue, OnlineQueueEntry
    ...
    # РћРїСЂРµРґРµР»СЏРµРј СѓРЅРёРєР°Р»СЊРЅС‹Рµ queue_tag РёР· СѓСЃР»СѓРі
    unique_queue_tags = set()
    for vs in visit_services:
        service = db.query(Service).filter(Service.id == vs.service_id).first()
    ...
    # РџРѕР»СѓС‡Р°РµРј РЅР°СЃС‚СЂРѕР№РєРё РѕС‡РµСЂРµРґРµР№
    queue_settings = {}  # РњРѕР¶РЅРѕ Р·Р°РіСЂСѓР·РёС‚СЊ РёР· РЅР°СЃС‚СЂРѕРµРє
    ...
    for queue_tag in unique_queue_tags:
        ...
        if queue_tag == "ecg" and not doctor_id:
            ...
            if lab_resource:
                ...
                if lab_doctor:
                    doctor_id = lab_doctor.id  # РСЃРїРѕР»СЊР·СѓРµРј doctor_id, Р° РЅРµ user_id
                    logger.info(
                        f"Р”Р»СЏ queue_tag={queue_tag} РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ СЂРµСЃСѓСЂСЃ-РІСЂР°С‡: lab_resource (Doctor ID: {doctor_id})"
                    )
                else:
        ...
        # РЎРѕР·РґР°РµРј Р·Р°РїРёСЃСЊ РІ РѕС‡РµСЂРµРґРё
        # queue_time - Р±РёР·РЅРµСЃ-РІСЂРµРјСЏ СЂРµРіРёСЃС‚СЂР°С†РёРё
        from datetime import datetime
        ...
        # в­ђ session_id РґР»СЏ РіСЂСѓРїРїРёСЂРѕРІРєРё СѓСЃР»СѓРі РїР°С†РёРµРЅС‚Р° РІ РѕРґРЅРѕР№ РѕС‡РµСЂРµРґРё
        ...
        queue_entry = OnlineQueueEntry(
            ...
            number=next_number,
            status="waiting",
            source="confirmation",  # РСЃС‚РѕС‡РЅРёРє: РїРѕРґС‚РІРµСЂР¶РґРµРЅРёРµ РІРёР·РёС‚Р°
            queue_time=queue_time,  # РЈСЃС‚Р°РЅР°РІР»РёРІР°РµРј РІСЂРµРјСЏ СЂРµРіРёСЃС‚СЂР°С†РёРё
            session_id=session_id,  # в­ђ NEW: Session grouping
        )
        db.add(queue_entry)
        ...
        # РџРѕРґРіРѕС‚Р°РІР»РёРІР°РµРј РґР°РЅРЅС‹Рµ РґР»СЏ РїРµС‡Р°С‚Рё С‚Р°Р»РѕРЅР°
        queue_names = {
            "ecg": "Р­РљР“",
            "cardiology_common": "РљР°СЂРґРёРѕР»РѕРі",
            "dermatology": "Р”РµСЂРјР°С‚РѕР»РѕРі",
        ...
        if doctor and doctor.user_id:
            user = db.query(User).filter(User.id == doctor.user_id).first()
            doctor_name = (user.full_name or user.username) if user else "Р‘РµР· РІСЂР°С‡Р°"
