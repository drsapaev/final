...
# M-1 (Manager deprecation): Manager removed from every report grant list.
# Collapse rule: [ADMIN, REGISTRAR, MANAGER] -> [ADMIN, REGISTRAR] (live
# product contract kept); [ADMIN, MANAGER] -> [ADMIN] (financial/doctor-
# performance reports had no independent Manager product requirement).
# POST /cleanup was already Admin-only and stays untouched.
