...
async def upload_photos(
    ...
    try:
        ...
        for file in files:
            ...
            # Создаем миниатюру
            thumbnail_path = os.path.join(f"{UPLOAD_DIR}/thumbnails", f"thumb_{filename}")
            try:
            ...
            "photos": [
                {
                    ...
                    "thumbnail_url": f"/api/v1/dermatology/photos/{photo.id}/thumbnail" if photo.thumbnail_path else None,
    ...
    try:
        ...
        return {
            "before": [
                ...
                for photo in photos if photo.category == "before"
            ],
            "after": [
                {
                    "id": photo.id,
                ...
                for photo in photos if photo.category == "after"
            ],
            "progress": [
                {
                    "id": photo.id,
                ...
                for photo in photos if photo.category == "progress"
            ]
        }
