...
from app.services.fcm_service import get_fcm_service, FCMService
    ...
    try:
        ...
        if len(device_tokens) == 1:
            ...
            return {
                ...
                "message": "Уведомление отправлено" if result.success else f"Ошибка: {result.error}",
