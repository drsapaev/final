...
async def get_kpi_metrics(
    ...
    kpi_data = {
        "metrics": {
            "revenue": {
                "value": AnalyticsService.calculate_revenue(
            ...
            "patients": {
                "value": analytics_service.get_patient_analytics(db, start, end).get(
                    "total_patients", 0
                ),
            ...
            "appointments": {
                "value": analytics_service.get_appointment_analytics(
                    db, start, end, department
                ).get("total_appointments", 0),
                "trend": analytics_service.get_appointment_trend(
                    db, start, end, department
                ),
            ...
            "doctors": {
                "value": analytics_service.get_doctor_performance(
                    db, start, end, department
                ).get("active_doctors", 0),
                "trend": analytics_service.get_doctor_efficiency_trend(
                    db, start, end, department
                ),
            ...
            "efficiency": {
                "value": analytics_service.get_efficiency_metrics(
                    db, start, end, department
                ).get("average_efficiency", 0),
                "trend": analytics_service.get_efficiency_trend(
                    db, start, end, department
                ),
                "label": "Эффективность",
            ...
            "satisfaction": {
                "value": analytics_service.get_satisfaction_metrics(
                    db, start, end, department
                ).get("average_rating", 0),
                "trend": analytics_service.get_satisfaction_trend(
                    db, start, end, department
                ),
            ...
            "wait_time": {
                "value": analytics_service.get_wait_time_metrics(
                    db, start, end, department
                ).get("average_wait_time", 0),
                "trend": analytics_service.get_wait_time_trend(
                    db, start, end, department
                ),
            ...
            "no_show_rate": {
                "value": analytics_service.get_no_show_metrics(
                    db, start, end, department
                ).get("no_show_rate", 0),
                "trend": analytics_service.get_no_show_trend(
                    db, start, end, department
                ),
        ...
        "summary": {
            "positive_trends": sum(
                1
                for m in analytics_service.get_all_trends(db, start, end, department)
                if m > 0
            ),
            "negative_trends": sum(
                1
            ...
            "achieved_goals": analytics_service.get_achieved_goals_count(
                db, start, end, department
            ),
            "total_metrics": 8,
        },
...
async def get_kpi_trends(
    ...
    trends_data = {
        "trends": analytics_service.get_detailed_trends(
            db, start, end, department, metric
        ),
        "period": {
            "start_date": start.isoformat(),
            "end_date": end.isoformat(),
