...
class FeatureFlagCreateRequest(BaseModel):
    ...
    environment: str = Field(default="all", pattern="^(production|staging|development|all)$")
...
class FeatureFlagUpdateRequest(BaseModel):
    ...
    environment: Optional[str] = Field(None, pattern="^(production|staging|development|all)$")
...
@router.post("/admin/feature-flags/{flag_key}/toggle", response_model=FeatureFlagStatusResponse)
...
@router.get("/admin/feature-flags/{flag_key}/history", response_model=List[FeatureFlagHistoryResponse])
...
@router.get("/feature-flags/status/{flag_key}", response_model=FeatureFlagStatusResponse)
...
def get_multiple_feature_flags_status(
    keys: str,  # Comma-separated list of flag keys
    db: Session = Depends(get_db)
):
    """
