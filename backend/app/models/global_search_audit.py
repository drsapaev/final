...
class GlobalSearchAudit(Base):
    ...
    result_types: Mapped[list[str] | None] = mapped_column(JSON, nullable=True)
    ...
    opened_type: Mapped[str | None] = mapped_column(String(20), nullable=True)  # patient|visit|lab
    opened_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
