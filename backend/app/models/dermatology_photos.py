...
class DermatologyPhoto(Base):
    ...
    thumbnail_path: Mapped[str | None] = mapped_column(String(500), nullable=True)  # Путь к миниатюре
    ...
    tags: Mapped[str | None] = mapped_column(String(500), nullable=True)  # Теги (через запятую)
