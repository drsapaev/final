...
class OnlineDay(Base):
    ...
    date_str: Mapped[str] = mapped_column(String(16), nullable=False, index=True)  # YYYY-MM-DD
    start_number: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    is_open: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True, server_default="1")