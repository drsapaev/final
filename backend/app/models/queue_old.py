...
class DailyQueue(Base):
    ...
    # Связи
    specialist = relationship("User", back_populates="daily_queues")
...
class QueueEntry(Base):
    ...
    id = Column(Integer, primary_key=True, index=True)
    queue_id = Column(Integer, ForeignKey("daily_queues.id"), nullable=False)
...
# Добавляем связи в существующие модели
