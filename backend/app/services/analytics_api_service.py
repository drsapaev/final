...
from app.repositories.analytics_api_repository import AnalyticsApiRepository

router = APIRouter()



def _repo(db: Session) -> AnalyticsApiRepository:
    return AnalyticsApiRepository(db)
