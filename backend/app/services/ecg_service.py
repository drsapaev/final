...
def parse_dicom_file(file_path: str) -> dict[str, Any] | None:
    """
...
def extract_waveform_data(ds) -> dict[str, list[float]] | None:
    """
    ...
    try:
        ...
        for _wf_idx, wf_item in enumerate(ds.WaveformSequence):
            # Получаем данные
...
def validate_dicom_file(file_path: str) -> tuple[bool, str | None]:
    """
