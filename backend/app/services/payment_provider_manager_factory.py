...
def _build_provider_config() -> dict[str, dict[str, object]]:
    return {
        "click": {
            "enabled": getattr(settings, "CLICK_ENABLED", False),
        ...
        "payme": {
            "enabled": getattr(settings, "PAYME_ENABLED", False),
            "merchant_id": getattr(settings, "PAYME_MERCHANT_ID", None),
            "secret_key": getattr(settings, "PAYME_SECRET_KEY", None),
            "base_url": getattr(
        ...
        "kaspi": {
            "enabled": getattr(settings, "KASPI_ENABLED", False),
            "merchant_id": getattr(settings, "KASPI_MERCHANT_ID", None),
            "secret_key": getattr(settings, "KASPI_SECRET_KEY", None),
