...
🕐 Обновлено: {datetime.now().strftime('%H:%M:%S')}"""
    ...
    async def _handle_admin_queues(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            for queue in queues:
                ...
                message += f"• В очереди: {queue.total_numbers - queue.current_number}\\n\\n"
            
            # Добавляем кнопки управления
            keyboard = {
                "inline_keyboard": [
                    [{"text": "🔄 Обновить", "callback_data": "admin_queues_refresh"}],
                    [{"text": "⏸ Приостановить все", "callback_data": "admin_queues_pause"}],
                    [{"text": "▶️ Запустить все", "callback_data": "admin_queues_resume"}]
                ]
            }
    ...
    async def _handle_admin_patients(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "🔍 Поиск пациента", "callback_data": "admin_patient_search"}],
                    [{"text": "📊 Статистика пациентов", "callback_data": "admin_patient_stats"}],
                    [{"text": "📋 Экспорт данных", "callback_data": "admin_patient_export"}]
                ]
            }
    ...
    async def _handle_admin_appointments(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "📋 Список записей", "callback_data": "admin_appointments_list"}],
                    [{"text": "📊 Статистика", "callback_data": "admin_appointments_stats"}],
                    [{"text": "📞 Напомнить пациентам", "callback_data": "admin_appointments_remind"}]
                ]
            }
...
Выберите тип уведомления:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "📱 SMS уведомления", "callback_data": "admin_notify_sms"}],
                    [{"text": "📧 Email уведомления", "callback_data": "admin_notify_email"}],
                    [{"text": "🤖 Telegram уведомления", "callback_data": "admin_notify_telegram"}],
                    [{"text": "📊 Статистика отправок", "callback_data": "admin_notify_stats"}],
    ...
    async def _handle_admin_doctors(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "👨‍⚕️ Добавить врача", "callback_data": "admin_doctor_add"}],
                    [{"text": "📊 Статистика врачей", "callback_data": "admin_doctor_stats"}],
                    [{"text": "📋 Расписание", "callback_data": "admin_doctor_schedule"}],
                    [{"text": "📞 Связаться с врачами", "callback_data": "admin_doctor_contact"}]
                ]
            }
    ...
    async def _handle_admin_services(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "💊 Добавить услугу", "callback_data": "admin_service_add"}],
                    [{"text": "📊 Статистика услуг", "callback_data": "admin_service_stats"}],
                    [{"text": "💰 Управление ценами", "callback_data": "admin_service_prices"}],
                    [{"text": "📋 Категории", "callback_data": "admin_service_categories"}]
                ]
            }
...
Выберите тип отчета:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "📅 Ежедневный отчет", "callback_data": "admin_report_daily"}],
                    [{"text": "📆 Недельный отчет", "callback_data": "admin_report_weekly"}],
                    [{"text": "📈 Месячный отчет", "callback_data": "admin_report_monthly"}],
                    [{"text": "💰 Финансовый отчет", "callback_data": "admin_report_financial"}],
                    [{"text": "👥 Отчет по пациентам", "callback_data": "admin_report_patients"}],
                    [{"text": "👨‍⚕️ Отчет по врачам", "callback_data": "admin_report_doctors"}],
                    [{"text": "📋 Экспорт данных", "callback_data": "admin_report_export"}]
                ]
            }
...
Выберите действие:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "💾 Создать резервную копию", "callback_data": "admin_backup_create"}],
                    [{"text": "📋 Список копий", "callback_data": "admin_backup_list"}],
                    [{"text": "🔄 Восстановить из копии", "callback_data": "admin_backup_restore"}],
                    [{"text": "🗑️ Удалить старые копии", "callback_data": "admin_backup_cleanup"}],
                    [{"text": "⚙️ Настройки резервирования", "callback_data": "admin_backup_settings"}]
                ]
            }
...
Выберите категорию настроек:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "🏥 Настройки клиники", "callback_data": "admin_settings_clinic"}],
                    [{"text": "📱 Уведомления", "callback_data": "admin_settings_notifications"}],
                    [{"text": "💰 Платежи", "callback_data": "admin_settings_payments"}],
                    [{"text": "📋 Очереди", "callback_data": "admin_settings_queues"}],
                    [{"text": "🤖 Telegram бот", "callback_data": "admin_settings_telegram"}],
                    [{"text": "🔐 Безопасность", "callback_data": "admin_settings_security"}],
                    [{"text": "📊 Интеграции", "callback_data": "admin_settings_integrations"}]
                ]
            }
        ...
        try:
            ...
            if not active_queues:
                ...
                for queue in active_queues:
                    ...
                    if waiting > 0:
                        ...
                        message += f"• Примерное время ожидания: {estimated_time} мин\\n"
            ...
            keyboard = {
                "inline_keyboard": [
                    ...
                    [{"text": "📱 Уведомить о подходе", "callback_data": "queue_notify"}]
                ]
            }
...
• Нажмите кнопку ниже для связи"""
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "📞 Связаться с дежурным врачом", "callback_data": "emergency_doctor"}],
                    [{"text": "🚑 Вызвать скорую", "url": "tel:103"}],
                    [{"text": "📍 Показать маршрут", "callback_data": "clinic_location"}]
                ]
            }
...
Мы ценим ваше мнение! Выберите тип обращения:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    ...
                    [{"text": "📞 Связаться с администрацией", "callback_data": "feedback_admin"}]
                ]
            }
            ...
            if not user:
                ...
                if appointments:
                    ...
                    for appointment in appointments:
                        ...
                        time_str = appointment.appointment_time.strftime('%H:%M') if appointment.appointment_time else 'Время не указано'
                        ...
                        message += f"👨‍⚕️ {appointment.doctor_name or 'Врач не указан'}\\n"
                        message += f"📋 Статус: {status}\\n\\n"
                else:
                ...
                keyboard = {
                    "inline_keyboard": [
                        [{"text": "📝 Записаться", "callback_data": "book_appointment"}],
                        [{"text": "🔄 Обновить", "callback_data": "refresh_appointments"}]
                    ]
                }
...
Выберите тип записи:"""
            ...
            keyboard = {
                "inline_keyboard": [
                    ...
                    [{"text": "📞 Позвонить в регистратуру", "callback_data": "call_registry"}]
                ]
            }
...
• Язык: {user.language or 'Русский'}"""
    ...
    async def _handle_services(self, chat_id: int, telegram_user, db: Session):
        ...
        try:
            ...
            keyboard = {
                "inline_keyboard": [
                    [{"text": "📝 Записаться на услугу", "callback_data": "book_service"}],
        ...
        try:
            ...
            if not user:
                ...
                if last_appointment:
                    ...
                    time_str = last_appointment.appointment_time.strftime('%H:%M') if last_appointment.appointment_time else 'Время не указано'
...
• Новости клиники"""
                ...
                keyboard = {
                    "inline_keyboard": [
                        ...
                        [{"text": "⚙️ Детальные настройки", "callback_data": "notification_details"}]
                    ]
                }
...
Попробуйте позже или обратитесь в техподдержку."""
    ...
    async def send_admin_notification(self, message: str, db: Session):
        ...
        try:
            ...
            for admin in admins:
                await self._send_message(admin.telegram_chat_id, f"🔔 **Уведомление администратора**\\n\\n{message}", parse_mode="Markdown")
