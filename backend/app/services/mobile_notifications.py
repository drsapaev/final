...
class MobileNotificationService:
    ...
    async def send_push_notification(
        ...
        try:
            ...
            notification_type = (
                data.get("notification_type", "push") if data else "push"
            )
            notification_data = {
    ...
    async def send_appointment_reminder(
        self, appointment_id: int, reminder_type: str = "24h"
    ) -> bool:
        ...
        try:
            ...
            return await self.send_push_notification(
                appointment.patient_id, title, message, data
            )
    ...
    async def send_queue_update(
        self, patient_id: int, queue_position: int, specialty: str
    ) -> bool:
    ...
    async def send_lab_results(
        self, patient_id: int, lab_result_id: int, test_name: str
    ) -> bool:
    ...
    async def send_payment_notification(
        self, patient_id: int, payment_id: int, amount: float, status: str
    ) -> bool:
