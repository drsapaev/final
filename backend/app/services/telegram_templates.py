...
class TelegramTemplatesService:
            ...
            "welcome": {
                ...
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📅 Qabulga yozilish", "callback_data": "book_menu"},
                                {"text": "📋 Mening qabullarim", "callback_data": "my_appointments"}
                            ],
                            [
            ...
            "appointment_reminder": {
                "ru": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "✅ Подтвердить", "callback_data": "confirm_{appointment_id}"},
                                {"text": "🔁 Перенести", "callback_data": "reschedule_{appointment_id}"}
                            ],
                            [
                                {"text": "❌ Отменить", "callback_data": "cancel_{appointment_id}"},
                                {"text": "📍 Маршрут", "url": "https://maps.google.com/?q={clinic_address}"}
                            ]
                        ]
                    }
                },
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "✅ Tasdiqlash", "callback_data": "confirm_{appointment_id}"},
                                {"text": "🔁 Ko'chirish", "callback_data": "reschedule_{appointment_id}"}
                            ],
                            [
                                {"text": "❌ Bekor qilish", "callback_data": "cancel_{appointment_id}"},
                                {"text": "📍 Yo'l", "url": "https://maps.google.com/?q={clinic_address}"}
                            ]
                        ]
                    }
                }
            ...
            "lab_results_ready": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                ...
                                {"text": "📞 Связаться с врачом", "callback_data": "contact_doctor_{doctor_id}"}
                            ],
                            [
                                {"text": "📅 Записаться на прием", "callback_data": "book_appointment"},
                                {"text": "🏥 Прийти в клинику", "url": "https://maps.google.com/?q={clinic_address}"}
                            ]
                        ]
                    }
                },
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📄 Natijalarni yuklab olish", "url": "{download_link}"},
                                {"text": "📞 Shifokor bilan bog'lanish", "callback_data": "contact_doctor_{doctor_id}"}
                            ],
                            [
                                {"text": "📅 Qabulga yozilish", "callback_data": "book_appointment"},
                                {"text": "🏥 Klinikaga kelish", "url": "https://maps.google.com/?q={clinic_address}"}
                            ]
                        ]
                    }
                }
            ...
            "payment_confirmation": {
                ...
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "🧾 Chekni yuklab olish", "url": "{receipt_link}"},
                                {"text": "📋 To'lovlar tarixi", "callback_data": "payment_history"}
                            ],
                            [
                                {"text": "📅 Mening qabullarim", "callback_data": "my_appointments"},
            ...
            "qr_code_message": {
                "ru": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📱 Открыть очередь", "url": "{queue_url}?token={qr_token}"},
                                {"text": "📍 Маршрут", "url": "https://maps.google.com/?q={clinic_address}"}
                            ],
                            [
                                {"text": "📞 Поддержка", "callback_data": "support"},
                                {"text": "🔄 Обновить", "callback_data": "refresh_qr_{appointment_id}"}
                            ]
                        ]
                    }
                },
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📱 Navbatni ochish", "url": "{queue_url}?token={qr_token}"},
                                {"text": "📍 Yo'l", "url": "https://maps.google.com/?q={clinic_address}"}
                            ],
                            [
                                {"text": "📞 Qo'llab-quvvatlash", "callback_data": "support"},
                                {"text": "🔄 Yangilash", "callback_data": "refresh_qr_{appointment_id}"}
                            ]
                        ]
                    }
                }
            ...
            "appointment_confirmed": {
                "ru": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📱 QR код", "callback_data": "get_qr_{appointment_id}"},
                                {"text": "📍 Маршрут", "url": "https://maps.google.com/?q={clinic_address}"}
                            ],
                            [
                                {"text": "📅 Мои записи", "callback_data": "my_appointments"},
                ...
                "uz": {
                    ...
                    "keyboard": {
                        "inline_keyboard": [
                            [
                                {"text": "📱 QR kod", "callback_data": "get_qr_{appointment_id}"},
                                {"text": "📍 Yo'l", "url": "https://maps.google.com/?q={clinic_address}"}
                            ],
                            [
                                {"text": "📅 Mening qabullarim", "callback_data": "my_appointments"},
    ...
    def get_template(self, template_key: str, language: str = "ru", data: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"text": f"Ошибка форматирования шаблона: {str(e)}", "keyboard": None}
    ...
    def get_abnormalities_text(self, has_abnormalities: bool, language: str = "ru") -> str:
        ...
        if language == "uz":
            return "⚠️ <b>E'tibor:</b> Natijalarda og'ishlar aniqlandi. Shifokor bilan maslahatlashingiz tavsiya etiladi." if has_abnormalities else "✅ Barcha ko'rsatkichlar normal doiralarda."
        else:
            return "⚠️ <b>Внимание:</b> В результатах выявлены отклонения. Рекомендуется консультация с врачом." if has_abnormalities else "✅ Все показатели в пределах нормы."
