...
def get_webhook_by_id(db: Session, webhook_id: int) -> PaymentWebhook | None:
...
def get_webhook_by_webhook_id(db: Session, webhook_id: str) -> PaymentWebhook | None:
...
def get_provider_by_id(db: Session, provider_id: int) -> PaymentProvider | None:
...
def get_provider_by_code(db: Session, code: str) -> PaymentProvider | None:
...
class CRUDPaymentWebhook:
    ...
    def get(self, db: Session, id: int) -> PaymentWebhook | None:
...
class CRUDPaymentTransaction:
    ...
    def get(self, db: Session, id: int) -> PaymentTransaction | None:
...
class CRUDPaymentProvider:
    ...
    def get(self, db: Session, id: int) -> PaymentProvider | None:
