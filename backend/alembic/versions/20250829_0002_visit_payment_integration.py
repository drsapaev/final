...
def upgrade() -> None:
    ...
    op.add_column("visits", sa.Column("payment_status", sa.String(length=32), nullable=True, server_default="unpaid"))
    op.add_column("visits", sa.Column("payment_amount", sa.Numeric(12, 2), nullable=True))
    op.add_column("visits", sa.Column("payment_currency", sa.String(length=3), nullable=True, server_default="UZS"))
    op.add_column("visits", sa.Column("payment_provider", sa.String(length=32), nullable=True))
    op.add_column("visits", sa.Column("payment_transaction_id", sa.String(length=255), nullable=True))
    op.add_column("visits", sa.Column("payment_webhook_id", sa.Integer(), nullable=True))
    op.add_column("visits", sa.Column("payment_processed_at", sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_index("ix_visits_payment_transaction", "visits", ["payment_transaction_id"])
