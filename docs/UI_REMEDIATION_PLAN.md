...
**Остаток после v2.4:** **Sprint 5 CLOSED** — PR-UI-15 ✅ COMPLETE (10 SP кредитованы; 6 инкрементов, см. §4.1.15); PR-UI-16 ✅ COMPLETE — 8 SP (см. §4.1.14); портфолио **17/19 PR · 92/103 SP**; остаток — PR-UI-17 ⬜ (5 SP, dep PR-UI-15 закрыт, готов к старту) и PR-UI-18 ⬜ (5 SP, последним). RoleGate Receptionist policy — по-прежнему deferred (§4.1.10 finding #1).
