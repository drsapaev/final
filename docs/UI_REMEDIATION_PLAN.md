...
| **6. Polish** | 11-12 | PR-UI-16, 17, 18 | Landing + cleanup (incl. M-8) + visual regression | 18 SP | 16 ✅ COMPLETE (5 инкрементов #2936/#2937/#2939/#2940/#2941 → `3e849b99`/`694aa515`/`1131ca98`/`304fd6b2`/`654c3409`, см. §4.1.14); 17 ⬜ (ждёт PR-UI-15); 18 ⬜ (последним) |
...
**Остаток после v2.3:** PR-UI-15 (10 SP) — in progress параллельной сессией (15-1..4 смержены; остаток 15-5..N на их усмотрение); PR-UI-16 ✅ COMPLETE — 8 SP кредитованы (см. §4.1.14); PR-UI-17 ⬜ (dep PR-UI-15); PR-UI-18 ⬜ (последним). RoleGate Receptionist policy — по-прежнему deferred (§4.1.10 finding #1).
