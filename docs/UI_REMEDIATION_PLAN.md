...
**Остаток после v2.2:** PR-UI-15 (10 SP) — in progress параллельной сессией (15-1..4 смержены: DoctorPanel views + ErrorBoundary, DentistPanelUnified data lifecycle + dialogs + protocols; остаток 15-5..N на их усмотрение); Sprint 6 (PR-UI-16/17/18) не начат. RoleGate Receptionist policy — по-прежнему deferred (§4.1.10 finding #1).
