...
6. **Impact on headline completion %:** 0% — deferral процессный (review coverage), не code-AC; zero-delta-by-construction + независимо верифицировано на merged tree (CI + post-merge аудит).
