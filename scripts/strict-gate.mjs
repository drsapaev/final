...
try {
  ...
  console.log('  - src/api/                (G7-D+E: ALL api files strict, tests excluded)');
  console.log('  - src/api/mappers/        (G7-A)');
  console.log('  - src/types/domain/       (G7-A)');
  console.log('  - src/types/              (G7-A)');
  console.log('  - src/stores/             (G7-B)');
  console.log('');
