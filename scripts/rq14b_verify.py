"""Self-contained RQ-14.b verification runner (lessons 48/49).
...
def main() -> int:
    argv = sys.argv[1:]
    if not argv:
        print("usage: rq14b_verify.py <pytest args...>", file=sys.stderr)
        return 2

    pgdata = tempfile.mkdtemp(prefix="rq14b_pgdata_")
