...
def upgrade() -> None:
    ...
    op.create_table('department_queue_settings',
        ...
        sa.Column('show_on_display', sa.Boolean(), nullable=False, server_default='true'),
    ...
    op.create_table('department_registration_settings',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('department_id', sa.Integer(), nullable=False),
        sa.Column('online_booking_enabled', sa.Boolean(), nullable=False, server_default='true'),
        ...
        sa.Column('auto_assign_doctor', sa.Boolean(), nullable=False, server_default='false'),
        sa.Column('allow_walkin', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('created_at', sa.DateTime(timezone=True),
            server_default=sa.text("(datetime('now'))"), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True),
            server_default=sa.text("(datetime('now'))"), nullable=False),
