...
| Info | Informational | http://127.0.0.1:8000 | Percentage of responses with status code 2xx | 50 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of responses with status code 4xx | 50 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of endpoints with content type application/json | 100 % |
| Info | Informational | http://127.0.0.1:8000 | Percentage of endpoints with method GET | 100 % |
| Info | Informational | http://127.0.0.1:8000 | Count of total endpoints | 2    |
